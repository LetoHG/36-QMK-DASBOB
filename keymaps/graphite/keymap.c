...
// ┌───────────────────────────── Left hand ─────────────────────────────┐    ┌────────────────────────────────── Right hand ─────────────────────────────────────┐
    ...
    MT(MOD_LSFT,KC_N), MT(MOD_LALT,KC_R), MT(MOD_LCTL,KC_T), MT(MOD_LGUI,KC_S), KC_G, /**/ KC_Y, MT(MOD_RCTL,KC_H), MT(MOD_RALT,KC_A), MT(MOD_RSFT,KC_E), MT(MOD_RGUI,KC_I),            // Row 2
    ...
    LT(_NAVIGATION, KC_ENT), LT(_SPECIAL, KC_SPC), OSM(MOD_LSFT), KC_SPC, KC_ENT, KC_BSPC
  ),

  [_ISRT] = LAYOUT(
// ┌────────────────────── Left hand ──────────────────────┐    ┌─────────────────────────── Right hand ──────────────────────────────┐
    KC_Y, KC_C, KC_L,              KC_M,              KC_K, /**/ KC_Z, KC_F,              KC_U,              TD(COMMA_MINUS), KC_BSPC, // Row 1
    KC_I, KC_S, MT(MOD_LSFT,KC_R), MT(MOD_LALT,KC_T), MT(MOD_LCTL,KC_G), /**/ KC_P, MT(MOD_RCTL,KC_N), MT(MOD_RALT,KC_E), MT(MOD_RSFT,KC_A), MT(MOD_RGUI,KC_O),    // Row 2
...
// ┌────────────────────── Left hand ──────────────────────┐    ┌───────────────────────────── Right hand ────────────────────────────────┐
    ...
    KC_A, KC_R, MT(MOD_LSFT,KC_S), MT(MOD_LALT,KC_T), MT(MOD_LCTL,KC_G), /**/ KC_M, MT(MOD_RCTL,KC_N), MT(MOD_RALT,KC_E), MT(MOD_RSFT,KC_I), MT(MOD_RGUI,KC_O),           // Row 2
...
// ┌────────────────────── Left hand ──────────────────────┐    ┌───────────────────────────── Right hand ────────────────────────────────┐
    ...
    KC_A, KC_S, MT(MOD_LSFT,KC_D), MT(MOD_LALT,KC_F), MT(MOD_LCTL,KC_G), /**/ KC_H, MT(MOD_RCTL,KC_J), MT(MOD_RALT,KC_K), MT(MOD_RSFT,KC_L),         MT(MOD_RGUI,KC_SCLN),        // Row 2
